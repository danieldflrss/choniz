...
class AlphaVantageForexProvider:
    ...
    async def get_forex_data(self, from_symbol: str, to_symbol: str) -> Optional[float]:
        ...
        try:
            ...
            if "Realtime Currency Exchange Rate" in data:
                ...
                self.logger.warning(
                    f"No se pudo obtener datos para {from_symbol}/{to_symbol}"
                )
                return None
    ...
    async def get_intraday_data(
        self, from_symbol: str, to_symbol: str, interval: str = "1min"
    ) -> List[Candle]:
        ...
        try:
            ...
            if time_series_key not in data:
                self.logger.warning(
                    f"No hay datos disponibles para {from_symbol}/{to_symbol}"
                )
                return []
