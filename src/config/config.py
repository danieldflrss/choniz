...
FOREX_OPTIMIZED_CONFIG = {
    ...
    "interval": "1min",
    "credentials": {"api_key": "9Q5ZV1NEBFQQZ76L"},
    "strategy_config": {
...
STOCK_OPTIMIZED_CONFIG = {
    ...
    "interval": "1m",
    "credentials": {"api_token": "TU_TOKEN_IEX_CLOUD"},
    "strategy_config": {
...
IQ_OPTIONS_OPTIMIZED_CONFIG = {
    ...
    "credentials": {"email": "trader.iqoptions@gmail.com", "password": "porunbeso99"},
...
SYSTEM_CONFIG = {
    ...
    "database_config": {"enabled": False, "type": "sqlite", "path": "trading_data.db"},
}
...
NOTIFICATION_CONFIG = {
    ...
    "discord": {"enabled": False, "webhook_url": "", "message_format": "compact"},
    "email": {
        "enabled": False,
        "smtp_server": "",
        "smtp_port": 587,
    ...
    "webhook": {"enabled": False, "url": "", "headers": {}, "format": "json"},
}
...
AGGRESSIVE_SCALPING_CONFIG = create_custom_config(
    "iqoptions",
    {
        "strategy_config": {
            "min_confidence": 0.55,
...
CONSERVATIVE_TRADING_CONFIG = create_custom_config(
    "iqoptions",
    {
        "strategy_config": {
            "min_confidence": 0.80,
...
BALANCED_TRADING_CONFIG = (
    IQ_OPTIONS_OPTIMIZED_CONFIG  # Configuración balanceada por defecto
)
